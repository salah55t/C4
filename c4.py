# ملف c4.py - نسخة V9.5.0 (استراتيجية جديدة وإصلاحات)
# --- التغييرات الرئيسية (V9.5.0):
# 1. [إصلاح] تمت معالجة مشكلة عدم ظهور زر تفعيل استراتيجية ML في لوحة التحكم.
# 2. [إضافة] تم دمج "استراتيجية الاختراق الذكي" (Smart Breakout) الجديدة.
# 3. [إضافة] مؤشرات فنية جديدة (VWAP, OBV, CMF) لدعم الاستراتيجية الجديدة.
# 4. [إضافة] زر تفعيل خاص بالاستراتيجية الجديدة في لوحة التحكم.
...
# [إضافة] مفتاح تفعيل الاستراتيجية الجديدة
...
<head>
    ...
    <title>لوحة تحكم التداول V9.5.0 - إضافة استراتيجية</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link href="https://fonts.googleapis.com/css2?family=Tajawal:wght@400;500;700;800&display=swap" rel="stylesheet">
    <style>
        :root { --bg-main: #0D1117; --bg-card: #161B22; --border-color: #30363D; --text-primary: #E6EDF3; --text-secondary: #848D97; --accent-blue: #58A6FF; --accent-green: #3FB950; --accent-red: #F85149; --accent-yellow: #D29922; --accent-purple: #A371F7; --accent-teal: #39D3BB;}
...
function updateMarketStatus() {
    fetchData('/api/market_status').then(data => {
        ...
        if(data.settings) {
            ...
            // [إصلاح و إضافة] تحديث أزرار الاستراتيجيات
...
function saveSettings() {
    const settings = {
        ...
        // [إصلاح و إضافة] إرسال حالة كل الاستراتيجيات
...
def get_market_status():
    ...
    # [إصلاح و إضافة] قراءة حالة كل الاستراتيجيات
    ...
    return jsonify({
        ...
        "settings": {
            ...
            # [إصلاح و إضافة] إرسال حالة كل الاستراتيجيات للواجهة الأمامية
...
def update_settings():
    ...
    try:
        ...
        # [إصلاح و إضافة] تحديث حالة كل الاستراتيجيات
            ...
            for i in range(0, len(symbols_to_process), SYMBOL_PROCESSING_BATCH_SIZE):
                ...
                for symbol in batch:
                    try:
                        ...
                        strategies_for_htf = ["EMA_RSI_Cross", "Bullish_Momentum", "MACD_EMA_Crossover", "Pullback_MACD", "Smart_Breakout_VWAP"]
