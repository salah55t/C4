...
SPEED_FILTER_REL_VOL_THRESHOLD: float = 1.0  # الحد الأدنى لحجم التداول النسبي للدلالة على اهتمام المتداولين
SPEED_FILTER_RSI_MIN: float = 30.0  # الحد الأدنى لمؤشر RSI (يجب أن يكون في منطقة الزخم الصاعد)
