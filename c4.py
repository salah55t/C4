...
FILTER_PROFILES: Dict[str, Dict[str, Any]] = {
    "STRONG_UPTREND": {
        ...
        "strategy": "MOMENTUM",
        "filters": { 
            "adx": 30.0, "rel_vol": 0.5, "rsi_range": (55, 95), "roc": 0.15, 
            "slope": 0.08, "min_rrr": 1.2, "min_volatility_pct": 0.25, 
    ...
    "UPTREND": {
        ...
        "strategy": "MOMENTUM",
        "filters": { 
            "adx": 24.0, "rel_vol": 0.2, "rsi_range": (50, 90), "roc": 0.05, 
            "slope": 0.04, "min_rrr": 1.3, "min_volatility_pct": 0.10, 
