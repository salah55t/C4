...
class ScalpingTradingStrategy:
    ...
    def generate_buy_signal(self, df_processed: pd.DataFrame) -> Optional[Dict[str, Any]]:
        ...
        signal_output = {
            ...
            'initial_stop_loss': initial_stop_loss, # Default SL to 0.0
            'current_target': float(f"{initial_target:.8g}"),
            'current_stop_loss': initial_stop_loss, # Default SL to 0.0
...
def track_signals() -> None:
    ...
    while True:
        ...
        try:
            ...
            logger.info("ℹ️ [Tracker] Waiting 120 seconds before retrying...")
            time.sleep(120)
