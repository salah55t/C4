...
def passes_speed_filter(last_features: pd.Series) -> bool:
    ...
    if regime in ["DOWNTREND", "STRONG DOWNTREND"]:
        ...
        return True
    if regime == "STRONG UPTREND": adx_threshold, rel_vol_threshold, rsi_min, rsi_max = (25.0, 0.4, 45.0, 85.0)
    elif regime == "UPTREND": adx_threshold, rel_vol_threshold, rsi_min, rsi_max = (22.0, 0.3, 40.0, 80.0)
