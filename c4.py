...
def passes_speed_filter(last_features: pd.Series) -> bool:
    ...
    if regime in ["DOWNTREND", "STRONG DOWNTREND"]:
        ...
        return True
    if regime == "STRONG UPTREND": adx_threshold, rel_vol_threshold, rsi_min, rsi_max = (30.0, 0.4, 50.0, 75.0)
    elif regime == "UPTREND": adx_threshold, rel_vol_threshold, rsi_min, rsi_max = (25.0, 0.3, 45.0, 75.0)
    else: adx_threshold, rel_vol_threshold, rsi_min, rsi_max = (20.0, 0.2, 35.0, 65.0)
