...
SPEED_FILTER_ADX_THRESHOLD: float = 25.0  # الحد الأدنى لمؤشر ADX للدلالة على وجود اتجاه قوي
SPEED_FILTER_REL_VOL_THRESHOLD: float = 1.5  # الحد الأدنى لحجم التداول النسبي للدلالة على اهتمام المتداولين
